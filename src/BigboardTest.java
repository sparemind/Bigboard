...
public class BigboardTest {
    ...
    public void randTestAnd() {
        ...
        randTestBiBBFunc(BigboardTest::and, Bigboard::and);
    }

    @Test
    public void randTestOr() {
        System.out.println("Testing or():");
        randTestBiBBFunc(BigboardTest::or, Bigboard::or);
    }

    @Test
    public void randTestXor() {
        System.out.println("Testing xor():");
        randTestBiBBFunc(BigboardTest::xor, Bigboard::xor);
    }

    @Test
    public void randTestLeft() {
        System.out.println("Testing left():");
        randTestBBFunc(BigboardTest::left, Bigboard::left);
    }

    @Test
    public void randTestRight() {
        System.out.println("Testing right():");
        randTestBBFunc(BigboardTest::right, Bigboard::right);
    }

    /**
     * Tests a binary Bigboard function for a series of random boards, where the
     * second argument of the function is another Bigboard. Actual results are
     * compared against expected results generated by a separate function that
     * produces its results using only the indices of the set bits in the boards
     * being given to the tested function.
     * <p>
     ...
     *                     and returns a third.
     */
    private void randTestBiBBFunc(BiFunction<List<Integer>, List<Integer>, int[]> expectedFunc,
    ...
    /**
     * Tests a binary Bigboard function for a series of random boards, where the
     * second argument of the function is an integer value. Actual results are
     * compared against expected results generated by a separate function that
     * produces its results using only the indices of the set bits in the boards
     * being given to the tested function.
     * <p>
     ...
     */
    private void randTestBBFunc(BiFunction<List<Integer>, Integer, int[]> expectedFunc,
